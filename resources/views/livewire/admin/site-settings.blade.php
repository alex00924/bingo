<div>
    ...
    <div class="mt-8 p-5 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="mt-5">
            ...
            <x-text-input wire:model="minimumQuantity" id="minimum-quantity" class="block mt-1 w-full" name="minimum-quantity" required autofocus autocomplete="minimum-quantity" />
